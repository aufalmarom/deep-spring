...
import com.domain.explore.dto.CategoryDTO;
...
import com.domain.explore.services.CategoryService;
...
public class CategoryController {
    ...
    public Iterable<Category> findByNamePaging(@RequestBody SearchDTO searchDTO, @PathVariable("size") int size,
    ...
    public Iterable<Category> findByNameSort(@RequestBody SearchDTO searchDTO, @PathVariable("size") int size,
